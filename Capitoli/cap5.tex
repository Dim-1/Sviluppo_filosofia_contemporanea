...
il verbo latino "\textit{differre}":

\begin{itemize}
	\item \textit{différence} : è il termine francese che in italiano
	possiede lo stesso significato del termine "differenza";
	\item \textit{différance}: è il nuovo termine che occorre a Derrida
...
La scrittura è la depositaria del senso, ma questo non
...
esposto, il senso contenuto nella scrittura è
in realtà assenza di senso, dato che non
riesce a conseguire una determinazione
conclusiva.

Ogni senso determinato ricade sotto il dominio della
presenza.
...
potersi sottrarre al mascheramento, e interpretare è
...
pensata da Hegel è discorsiva, pensata, e
...
La metafisica è la rimozione della \textit{différance} e
...
al \textit{logos}. Derrida distingue tra "testo" e "libro":
...
Come in Heidegger l'essere è all'origine della
...
da Derrida: per lui la \textit{différance} è collocata
...
La "grammatologia" ha per oggetto la scrittura e
...
Decostruire significa distruggere e ricostruire,
...
Inoltre per Derrida il dialogo lavora contro la
...
rispetto ai parlanti e nel primato della tradizione.
...
pratico-politiche diverse: non c'è autorità

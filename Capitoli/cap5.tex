...
sta una radicale "epoché", una sospensione del
...
il mondo e la natura sono "messi fra parentesi",
...
Il fenomeno husserliano è il puro darsi originario
di cui la cosa è una costruzione successiva.

In Kant il processo di costruzione della cosa
...
ma la descrizione dell'esperienza originaria;
...
Rispetto a Hume, per Husserl alla scepsi deve
...
Per essa è impossibile descrivere in maniera obiettiva
...
sempre in potenza); perciò ogni opera di
...
i fenomeni si riconducono: infatti i fenomeni
...
colore senza una superficie, o una luminosità senza colore, eccetera. C'è una "struttura
...
Il fondo ultimo dei fenomeni si raggiunge
...
fenomeni, vi si accede grazie all'intuizione, cioè
...
immanenti all'esperienza stessa. Le eidos
...
immanente alla "materia" del mondo, differenziandolo dall'"a priori" formale Kantiano.
Questa legge essenziale che regola la nostra
esperienza è indipendente dal soggetto o dall'esigenza di avere un'esperienza ordinata;
è una "legalità oggettiva" appartenente alla

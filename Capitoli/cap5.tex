...
il metodo fenomenologico è in grado di accettare
...
Husserl la definisce "esperienza dell'estraneità",
...
Husserl chiama "esperienza del proprio corpo":

\begin{itemize}
	\item Korper, corpo fisico-spaziale, di cui ho
	esperienza esterna.
	\item Leib, corpo organico, con cui si ha sensazione
	interna del proprio corpo, come veicolo di
	conoscenze percettive e perciò più "soggetto"
	che "oggetto" dell'esperienza.
\end{itemize}

In altre parole il mio corpo può essere sia oggetto
...
L'altro non è percepito in modo evidente, come
...
trasferimento di senso; in altre parole l'altro soggetto viene interpretato.
...
Se tutti condividiamo la stessa natura, assieme
...
Il mondo oggettivo è perciò il prodotto della
...
L'attestazione fenomenologica della relazione di
somiglianza non è coerente con il rigore
apodittico cui la fenomenologia dovrebbe
...
proprio. Attenendosi al puro vedere non potrò mai
...
La crisi delle scienze consiste nella perdita del loro
...
l'aspetto meramente quantitativo (come già osservato da Weber con la sua teoria di razionalizzazione del mondo, intesa come quantizzazione misurabile e calcolabile, che porta al disincanto da parte dell'umanità,  ad una mancanza di significato nello svolgersi della vita e ad una diminuita libertà personale, essendo gli individui guidati da questa razionalità,  burocratica ed economica).

Per Husserl dobbiamo compiere un'operazione fenomenologica,
...
spazio-tempo (sempre come affermato da Weber, crediamo nella razionalità,  perché ci serve da un punto di vista pratico, senza tuttavia dare nessuna dimostrazione teoretica della razionalità del mondo).
 ...
 La Lebenswelt non è solo un mondo
...
Questo orizzonte trascendentale è a sua volta
costituito, carico di integrazioni di senso, e,
per Husserl e il filosofo, bisognoso di essere sottoposto ad
una riduzione trascendentale: il mondo vitale
non va indagato con l'atteggiamento della vita
naturale mondana, ma richiede "un'epoché universale
...
L'indagine sull'orizzonte trascendentale della
